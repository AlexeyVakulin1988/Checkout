Please.com Cucumber Boilerplate
====================
...
1. Download the latest stable release [here](https://gitlab.com/testproio/please-qa-bdd/-/archive/master/please-qa-bdd-master.zip) or clone the git repo — `git clone https://gitlab.com/testproio/please-qa-bdd.git`
...
To configure your tests, checkout the [`wdio.conf.js`](https://gitlab.com/testproio/please-qa-bdd/blob/master/wdio.conf.js) file in your test directory. It comes with a bunch of documented options you can choose from.
